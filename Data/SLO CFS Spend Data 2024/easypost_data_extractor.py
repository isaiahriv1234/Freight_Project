...
# #                     'from_name': shipment.from_address.name if shipment.from_address else '',
# #                     'from_city': shipment.from_address.city if shipment.from_address else '',
# #                     'from_state': shipment.from_address.state if shipment.from_address else '',
# #                     'to_name': shipment.to_address.name if shipment.to_address else '',
# #                     'to_city': shipment.to_address.city if shipment.to_address else '',
# #                     'to_state': shipment.to_address.state if shipment.to_address else '',
# #                     'selected_rate_cost': float(shipment.selected_rate.rate) if shipment.selected_rate else 0,
# #                     'selected_rate_carrier': shipment.selected_rate.carrier if shipment.selected_rate else '',
# #                     'selected_rate_service': shipment.selected_rate.service if shipment.selected_rate else '',
# #                     'parcel_weight': shipment.parcel.weight if shipment.parcel else 0,
# #                     'parcel_length': shipment.parcel.length if shipment.parcel else 0,
# #                     'parcel_width': shipment.parcel.width if shipment.parcel else 0,
# #                     'parcel_height': shipment.parcel.height if shipment.parcel else 0
# #                 }
...
# #                 if rates:
# #                     sample_rate = rates[0]  # Use first rate as example
# #                     features.update({
# #                         'alternative_cost_ups': sample_rate['rate'] if sample_rate['carrier'] == 'UPS' else None,
# #                         'alternative_cost_fedex': sample_rate['rate'] if sample_rate['carrier'] == 'FedEx' else None,
# #                         'alternative_cost_usps': sample_rate['rate'] if sample_rate['carrier'] == 'USPS' else None,
# #                         'potential_savings': max(0, row['Shipping_Cost'] - sample_rate['rate']),
# #                         'optimization_opportunity': 1 if row['Shipping_Cost'] > sample_rate['rate'] else 0
# #                     })
# #                 
